    ...
    <div ref={ref} className="relative">
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div className="px-3 py-2 border-b border-theme-border-subtle flex items-center justify-between">
              <span className="text-sm font-medium text-theme-fg">{t(locale, 'jobsInProgress.title')}</span>
              {(completedToasts.length > 0 || failedToasts.length > 0) && (
                <button
                  type="button"
                  ...
                  className="p-1 rounded-md text-theme-fg-subtle hover:text-theme-fg hover:bg-theme-bg-hover transition-colors"
                >
            ...
            {totalCount > 0 && (
              <Link
                ...
                className="block px-3 py-2 text-center text-xs italic text-theme-fg-subtle hover:text-theme-fg hover:bg-theme-bg-hover transition-colors border-t border-theme-border-subtle"
              >
                {t(locale, 'jobsInProgress.seeAllHistory')}
              </Link>
            )}
          </motion.div>
        )}

...
const dict: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'home.section.chat.title': 'Conversations that flow',
    'home.section.chat.desc': 'Chat with AI, get ideas, and refine your prompts. Natural dialogue and text generation in one place.',
    'home.section.chat.cta': 'Try chat',
    'home.section.image.title': 'Images from your words',
    'home.section.image.desc': 'Describe what you see in your mind. Generate unique images in seconds with a single prompt.',
    'home.section.image.cta': 'Create images',
    'home.section.video.title': 'Short videos from a prompt',
    'home.section.video.desc': 'Turn text or images into short AI clips. Simple, fast, no editing required.',
  ...
  de: {
    ...
    'home.section.chat.title': 'Gespräche die fließen',
    'home.section.chat.desc': 'Chatte mit KI, hole dir Ideen und verfeinere deine Prompts. Natürlicher Dialog und Texterstellung an einem Ort.',
    'home.section.chat.cta': 'Chat ausprobieren',
    'home.section.image.title': 'Bilder aus deinen Worten',
    'home.section.image.desc': 'Beschreibe, was du dir vorstellst. Erzeuge einzigartige Bilder in Sekunden mit einem Prompt.',
    'home.section.image.cta': 'Bilder erstellen',
    'home.section.video.title': 'Kurze Videos aus einem Prompt',
    'home.section.video.desc': 'Verwandle Text oder Bilder in kurze KI-Clips. Einfach, schnell, ohne Schnitt.',

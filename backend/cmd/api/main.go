...
func main() {
	...
	srv := api.NewServer(db, asynqClient, s3Store, streamSub, apiCache, repl, cfg.ModelRemoveBg, cfg.ModelText, cfg.ModelTextFallback, cfg.Redis, cfg.SupabaseJWTSecret, jwks, cfg.SupabaseURL, cfg.SupabaseServiceRole)

...
- [[skill:video]] — user wants a NEW short video/clip (optionally from an attached or previous image: "animă poza", "make a video from this", "these cars"). Duration 4, 6, or 8 seconds if the user names one (Veo 3.1). Multiple attached photos become reference images.
